appToMount.component('hero-section', {
      ...
      <div class="hero-body no-padding-h">
        ...
        <div class="hero-video-container">
          <iframe
            ...
            allowfullscreen
          ></iframe>
          <img class="hero-video" :src="heroVideoFallbackPath" />
        </div>
      </div>
  ...
  data() {
    return {
      ...
      heroVideoFallbackPath: './src/assets/hero-fallback-image.png',
      ...
      socials: [
        {
          ...
          iconPath: './src/assets/icons8-linkedin-48.png'
        },
        {
          name: 'Behance',
          link: 'https://www.behance.net/giociudadano',
          iconPath: './src/assets/icons8-behance-48.png'
        },
        {
          name: 'GitHub',
          link: 'https://www.github.com/giociudadano',
          iconPath: './src/assets/icons8-github-48.png'
        }
      ],
